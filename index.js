 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $(e=Kn()){return No().then(t=>{if(!t)throw f.create("unsupported-browser")},t=>{throw f.create("indexed-db-unsupported")}),fe(x(e),"messaging").getImmediate()}async function kt(e,t){return e=x(e),Ct(e,t)}function $o(e){return e=x(e),Bo(e)}function Po(e,t){return e=x(e),Mo(e,t)}Oo();const Ro="BNzzAggNxmOojT02qwgki86L4FmcISXnaGKEKFhpbeKFWgv-BD8lKCH3bci7N1QucvHWowVR1ezyp7v20FRePmc";var Lo="firebase",Fo="10.7.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */m(Lo,Fo,"app");const xo={apiKey:"AIzaSyALas5seudUODEpU_fS9mq_rj4kGRV3Ipk",authDomain:"hello-silbo.firebaseapp.com",projectId:"hello-silbo",storageBucket:"hello-silbo.firebasestorage.app",messagingSenderId:"388253311039",appId:"1:388253311039:web:371106f28bd330bd7b988a",measurementId:"G-9C78TZZPFC"};function jo(){return Xe(xo)}jo();const Ot="token_div",Nt="permission_div";Po($(),e=>{console.log("Message received. ",e),Wo(e)});async function Se(){qo(),P("loading..."),kt($(),{vapidKey:Ro,serviceWorkerRegistration:await navigator.serviceWorker.ready}).then(e=>{e?(Ho(e),zo(e)):(console.log("No registration token available. Request permission to generate one."),Go(),R(!1))}).catch(e=>{console.log("An error occurred while retrieving token. ",e),P("Error retrieving registration token."),R(!1)})}function P(e){const t=document.querySelector("#token");t.textContent=e}function Ho(e){Vo()?console.log("Token already sent to server so won't send it again unless it changes"):(console.log("Sending token to server...",e),R(!0))}function Vo(){return window.localStorage.getItem("sentToServer")==="1"}function R(e){window.localStorage.setItem("sentToServer",e?"1":"0")}function L(e,t){const n=document.querySelector("#"+e);t?n.style.display="block":n.style.display="none"}function Ko(){console.log("Requesting permission..."),Notification.requestPermission().then(e=>{console.log("Permission: ",e),e==="granted"?(console.log("Notification permission granted."),Se()):console.log("Unable to get permission to notify.")})}function Uo(){kt($()).then(e=>{$o($()).then(()=>{console.log("Token deleted.",e),R(!1),Se()}).catch(t=>{console.log("Unable to delete token. ",t)})}).catch(e=>{console.log("Error retrieving registration token. ",e),P("Error retrieving registration token.")})}function Wo(e){const t=document.querySelector("#messages"),n=document.createElement("h5"),r=document.createElement("pre");r.style.overflowX="hidden;",n.textContent="Received message:",r.textContent=JSON.stringify(e,null,2),t.appendChild(n),t.appendChild(r)}function qo(){const e=document.querySelector("#messages");for(;e.hasChildNodes();)e.removeChild(e.lastChild)}function zo(e){L(Ot,!0),L(Nt,!1),P(e)}function Go(){L(Ot,!1),L(Nt,!0)}document.getElementById("request-permission-button").addEventListener("click",Ko);document.getElementById("delete-token-button").addEventListener("click",Uo);Se();
