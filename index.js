 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ft=()=>Lt().__FIREBASE_DEFAULTS__,xt=()=>{if(typeof process>"u"||typeof process.env>"u")return;const e={}.__FIREBASE_DEFAULTS__;if(e)return JSON.parse(e)},jt=()=>{if(typeof document>"u")return;let e;try{e=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch{return}const t=e&&Pt(e[1]);return t&&JSON.parse(t)},Ht=()=>{try{return Ft()||xt()||jt()}catch(e){console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${e}`);return}},qe=()=>{var e;return(e=Ht())===null||e===void 0?void 0:e.config};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const E=new tn("@firebase/app"),gn="@firebase/app-compat",mn="@firebase/analytics-compat",bn="@firebase/analytics",wn="@firebase/app-check-compat",yn="@firebase/app-check",In="@firebase/auth",En="@firebase/auth-compat",vn="@firebase/database",Sn="@firebase/database-compat",_n="@firebase/functions",Tn="@firebase/functions-compat",Dn="@firebase/installations",An="@firebase/installations-compat",Cn="@firebase/messaging",kn="@firebase/messaging-compat",On="@firebase/performance",Nn="@firebase/performance-compat",Bn="@firebase/remote-config",Mn="@firebase/remote-config-compat",$n="@firebase/storage",Rn="@firebase/storage-compat",Pn="@firebase/firestore",Ln="@firebase/firestore-compat",Fn="firebase";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function be(e,t=!1){let n;const r=await H(e.appConfig,i=>{if(!wt(i))throw S.create("not-registered");const s=i.authToken;if(!t&&Lr(s))return i;if(s.requestStatus===1)return n=Rr(e,t),i;{if(!navigator.onLine)throw S.create("app-offline");const a=xr(i);return n=Pr(e,a),a}});return n?await n:r.authToken}async function Rr(e,t){let n=await Pe(e.appConfig);for(;n.authToken.requestStatus===1;)await ft(100),n=await Pe(e.appConfig);const r=n.authToken;return r.requestStatus===0?be(e,t):r}function Pe(e){return H(e,t=>{if(!wt(t))throw S.create("not-registered");const n=t.authToken;return jr(n)?Object.assign(Object.assign({},t),{authToken:{requestStatus:0}}):t})}async function Pr(e,t){try{const n=await Mr(e,t),r=Object.assign(Object.assign({},t),{authToken:n});return await M(e.appConfig,r),n}catch(n){if(st(n)&&(n.customData.serverCode===401||n.customData.serverCode===404))await mt(e.appConfig);else{const r=Object.assign(Object.assign({},t),{authToken:{requestStatus:0}});await M(e.appConfig,r)}throw n}}function wt(e){return e!==void 0&&e.registrationStatus===2}function Lr(e){return e.requestStatus===2&&!Fr(e)}function Fr(e){const t=Date.now();return t<e.creationTime||e.creationTime+e.expiresIn<t+lr}function xr(e){const t={requestStatus:1,requestTime:Date.now()};return Object.assign(Object.assign({},e),{authToken:t})}function jr(e){return e.requestStatus===1&&e.requestTime+rt<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Vr(e,t=!1){const n=e;return await Kr(n),(await be(n,t)).token}async function Kr(e){const{registrationPromise:t}=await me(e);t&&await t}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ur(e){if(!e||!e.options)throw X("App Configuration");if(!e.name)throw X("App Name");const t=["projectId","apiKey","appId"];for(const n of t)if(!e.options[n])throw X(n);return{appName:e.name,projectId:e.options.projectId,apiKey:e.options.apiKey,appId:e.options.appId}}function X(e){return S.create("missing-app-config-values",{valueName:e})}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fo=7*24*60*60*1e3;async function ho(e){const t=await go(e.swRegistration,e.vapidKey),n={vapidKey:e.vapidKey,swScope:e.swRegistration.scope,endpoint:t.endpoint,auth:h(t.getKey("auth")),p256dh:h(t.getKey("p256dh"))},r=await vt(e.firebaseDependencies);if(r){if(mo(r.subscriptionOptions,n))return Date.now()>=r.createTime+fo?po(e,{token:r.token,createTime:Date.now(),subscriptionOptions:n}):r.token;try{await St(e.firebaseDependencies,r.token)}catch(o){console.warn(o)}return xe(e.firebaseDependencies,n)}else return xe(e.firebaseDependencies,n)}async function Tt(e){const t=await vt(e.firebaseDependencies);t&&(await St(e.firebaseDependencies,t.token),await ao(e.firebaseDependencies));const n=await e.swRegistration.pushManager.getSubscription();return n?n.unsubscribe():!0}async function po(e,t){try{const n=await lo(e.firebaseDependencies,t),r=Object.assign(Object.assign({},t),{token:n,createTime:Date.now()});return await ye(e.firebaseDependencies,r),n}catch(n){throw await Tt(e),n}}async function xe(e,t){const r={token:await uo(e,t),createTime:Date.now(),subscriptionOptions:t};return await ye(e,r),r.token}async function go(e,t){const n=await e.pushManager.getSubscription();return n||e.pushManager.subscribe({userVisibleOnly:!0,applicationServerKey:to(t)})}function mo(e,t){const n=t.vapidKey===e.vapidKey,r=t.endpoint===e.endpoint,o=t.auth===e.auth,i=t.p256dh===e.p256dh;return n&&r&&o&&i}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ao(e,t){const n=t.data;if(!n.isFirebaseMessaging)return;e.onMessageHandler&&n.messageType===k.PUSH_RECEIVED&&(typeof e.onMessageHandler=="function"?e.onMessageHandler(je(n)):e.onMessageHandler.next(je(n)));const r=n.data;Io(r)&&r[eo]==="1"&&await To(e,n.messageType,r)}const He="@firebase/messaging",Ve="0.12.5";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function No(){try{await Ge()}catch{return!1}return typeof window<"u"&&ze()&&Kt()&&"serviceWorker"in navigator&&"PushManager"in window&&"Notification"in window&&"fetch"in window&&ServiceWorkerRegistration.prototype.hasOwnProperty("showNotification")&&PushSubscription.prototype.hasOwnProperty("getKey")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $(e=Kn()){return No().then(t=>{if(!t)throw f.create("unsupported-browser")},t=>{throw f.create("indexed-db-unsupported")}),fe(x(e),"messaging").getImmediate()}async function kt(e,t){return e=x(e),Ct(e,t)}function $o(e){return e=x(e),Bo(e)}function Ro(e,t){return e=x(e),Mo(e,t)}Oo();const Po={apiKey:"AIzaSyAH2JIEEwn9GfYpfzlTpvUW4s0LD_iRwJQ",authDomain:"silbo-patient-transport.firebaseapp.com",projectId:"silbo-patient-transport",storageBucket:"silbo-patient-transport.firebasestorage.app",messagingSenderId:"27523190820",appId:"1:27523190820:web:6dcd16ac7bf6ff72e008b1"},Lo="BFs1O-6MsXDwy0GEZwqDZiKaToqjiAJ23MIuZTYBtj8k0Psr9NqTv4CTwlQJY5oCJYR4RmO7FhsMfeS0k0iMaBs";var Fo="firebase",xo="10.7.0";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */m(Fo,xo,"app");function jo(){return Xe(Po)}jo();const Ot="token_div",Nt="permission_div";Ro($(),e=>{console.log("Message received. ",e),Wo(e)});async function Se(){qo(),R("loading..."),kt($(),{vapidKey:Lo,serviceWorkerRegistration:await navigator.serviceWorker.ready}).then(e=>{e?(Ho(e),zo(e)):(console.log("No registration token available. Request permission to generate one."),Go(),P(!1))}).catch(e=>{console.log("An error occurred while retrieving token. ",e),R("Error retrieving registration token."),P(!1)})}function R(e){const t=document.querySelector("#token");t.textContent=e}function Ho(e){Vo()?console.log("Token already sent to server so won't send it again unless it changes"):(console.log("Sending token to server...",e),P(!0))}function Vo(){return window.localStorage.getItem("sentToServer")==="1"}function P(e){window.localStorage.setItem("sentToServer",e?"1":"0")}function L(e,t){const n=document.querySelector("#"+e);t?n.style.display="block":n.style.display="none"}function Ko(){console.log("Requesting permission..."),Notification.requestPermission().then(e=>{console.log("Permission: ",e),e==="granted"?(console.log("Notification permission granted."),Se()):console.log("Unable to get permission to notify.")})}function Uo(){kt($()).then(e=>{$o($()).then(()=>{console.log("Token deleted.",e),P(!1),Se()}).catch(t=>{console.log("Unable to delete token. ",t)})}).catch(e=>{console.log("Error retrieving registration token. ",e),R("Error retrieving registration token.")})}function Wo(e){const t=document.querySelector("#messages"),n=document.createElement("h5"),r=document.createElement("pre");r.style.overflowX="hidden;",n.textContent="Received message:",r.textContent=JSON.stringify(e,null,2),t.appendChild(n),t.appendChild(r)}function qo(){const e=document.querySelector("#messages");for(;e.hasChildNodes();)e.removeChild(e.lastChild)}function zo(e){L(Ot,!0),L(Nt,!1),R(e)}function Go(){L(Ot,!1),L(Nt,!0)}document.getElementById("request-permission-button").addEventListener("click",Ko);document.getElementById("delete-token-button").addEventListener("click",Uo);Se();
