 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Qn(e){v(new w("platform-logger",t=>new pn(t),"PRIVATE")),v(new w("heartbeat",t=>new Yn(t),"PRIVATE")),m(ie,ke,e),m(ie,ke,"esm2017"),m("fire-js","")}Qn("");var er="firebase",tr="10.7.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */m(er,tr,"app");const nr=(e,t)=>t.some(n=>e instanceof n);let Me,$e;function rr(){return Me||(Me=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function or(){return $e||($e=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}const tt=new WeakMap,ce=new WeakMap,nt=new WeakMap,z=new WeakMap,pe=new WeakMap;function ir(e){const t=new Promise((n,r)=>{const o=()=>{e.removeEventListener("success",i),e.removeEventListener("error",s)},i=()=>{n(b(e.result)),o()},s=()=>{r(e.error),o()};e.addEventListener("success",i),e.addEventListener("error",s)});return t.then(n=>{n instanceof IDBCursor&&tt.set(n,e)}).catch(()=>{}),pe.set(t,e),t}function sr(e){if(ce.has(e))return;const t=new Promise((n,r)=>{const o=()=>{e.removeEventListener("complete",i),e.removeEventListener("error",s),e.removeEventListener("abort",s)},i=()=>{n(),o()},s=()=>{r(e.error||new DOMException("AbortError","AbortError")),o()};e.addEventListener("complete",i),e.addEventListener("error",s),e.addEventListener("abort",s)});ce.set(e,t)}let ue={get(e,t,n){if(e instanceof IDBTransaction){if(t==="done")return ce.get(e);if(t==="objectStoreNames")return e.objectStoreNames||nt.get(e);if(t==="store")return n.objectStoreNames[1]?void 0:n.objectStore(n.objectStoreNames[0])}return b(e[t])},set(e,t,n){return e[t]=n,!0},has(e,t){return e instanceof IDBTransaction&&(t==="done"||t==="store")?!0:t in e}};function ar(e){ue=e(ue)}function cr(e){return e===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(t,...n){const r=e.call(G(this),t,...n);return nt.set(r,t.sort?t.sort():[t]),b(r)}:or().includes(e)?function(...t){return e.apply(G(this),t),b(tt.get(this))}:function(...t){return b(e.apply(G(this),t))}}function ur(e){return typeof e=="function"?cr(e):(e instanceof IDBTransaction&&sr(e),nr(e,rr())?new Proxy(e,ue):e)}function b(e){if(e instanceof IDBRequest)return ir(e);if(z.has(e))return z.get(e);const t=ur(e);return t!==e&&(z.set(e,t),pe.set(t,e)),t}const G=e=>pe.get(e);function dr(e,t,{blocked:n,upgrade:r,blocking:o,terminated:i}={}){const s=indexedDB.open(e,t),a=b(s);return r&&s.addEventListener("upgradeneeded",c=>{r(b(s.result),c.oldVersion,c.newVersion,b(s.transaction))}),n&&s.addEventListener("blocked",()=>n()),a.then(c=>{i&&c.addEventListener("close",()=>i()),o&&c.addEventListener("versionchange",()=>o())}).catch(()=>{}),a}const lr=["get","getKey","getAll","getAllKeys","count"],fr=["put","add","delete","clear"],J=new Map;function Re(e,t){if(!(e instanceof IDBDatabase&&!(t in e)&&typeof t=="string"))return;if(J.get(t))return J.get(t);const n=t.replace(/FromIndex$/,""),r=t!==n,o=fr.includes(n);if(!(n in(r?IDBIndex:IDBObjectStore).prototype)||!(o||lr.includes(n)))return;const i=async function(s,...a){const c=this.transaction(s,o?"readwrite":"readonly");let u=c.store;return r&&(u=u.index(a.shift())),(await Promise.all([u[n](...a),o&&c.done]))[0]};return J.set(t,i),i}ar(e=>({...e,get:(t,n,r)=>Re(t,n)||e.get(t,n,r),has:(t,n)=>!!Re(t,n)||e.has(t,n)}));const rt="@firebase/installations",ge="0.6.4";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ot=1e4,it=`w:${ge}`,st="FIS_v2",hr="https://firebaseinstallations.googleapis.com/v1",pr=60*60*1e3,gr="installations",mr="Installations";/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Sr=/^[cdef][\w-]{21}$/,de="";function _r(){try{const e=new Uint8Array(17);(self.crypto||self.msCrypto).getRandomValues(e),e[0]=112+e[0]%16;const n=Tr(e);return Sr.test(n)?n:de}catch{return de}}function Tr(e){return vr(e).substr(0,22)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function be(e){let t;const n=await H(e.appConfig,r=>{const o=Nr(r),i=Br(e,o);return t=i.registrationPromise,i.installationEntry});return n.fid===de?{installationEntry:await t}:{installationEntry:n,registrationPromise:t}}function Nr(e){const t=e||{fid:_r(),registrationStatus:0};return wt(t)}function Br(e,t){if(t.registrationStatus===0){if(!navigator.onLine){const o=Promise.reject(S.create("app-offline"));return{installationEntry:t,registrationPromise:o}}const n={fid:t.fid,registrationStatus:1,registrationTime:Date.now()},r=Mr(e,n);return{installationEntry:n,registrationPromise:r}}else return t.registrationStatus===1?{installationEntry:t,registrationPromise:$r(e)}:{installationEntry:t}}async function Mr(e,t){try{const n=await Er(e,t);return M(e.appConfig,n)}catch(n){throw at(n)&&n.customData.serverCode===409?await bt(e.appConfig):await M(e.appConfig,{fid:t.fid,registrationStatus:0}),n}}async function $r(e){let t=await Pe(e.appConfig);for(;t.registrationStatus===1;)await ht(100),t=await Pe(e.appConfig);if(t.registrationStatus===0){const{installationEntry:n,registrationPromise:r}=await be(e);return r||n}return t}function Pe(e){return H(e,t=>{if(!t)throw S.create("installation-not-found");return wt(t)})}function wt(e){return Rr(e)?{fid:e.fid,registrationStatus:0}:e}function Rr(e){return e.registrationStatus===1&&e.registrationTime+ot<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Ur(e){const t=e,{installationEntry:n,registrationPromise:r}=await be(t);return r?r.catch(console.error):we(t).catch(console.error),n.fid}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Wr(e,t=!1){const n=e;return await qr(n),(await we(n,t)).token}async function qr(e){const{registrationPromise:t}=await be(e);t&&await t}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const It="installations",Gr="installations-internal",Jr=e=>{const t=e.getProvider("app").getImmediate(),n=zr(t),r=he(t,"heartbeat");return{app:t,appConfig:n,heartbeatServiceProvider:r,_delete:()=>Promise.resolve()}},Yr=e=>{const t=e.getProvider("app").getImmediate(),n=he(t,It).getImmediate();return{getId:()=>Ur(n),getToken:o=>Wr(n,o)}};function Xr(){v(new w(It,Jr,"PUBLIC")),v(new w(Gr,Yr,"PRIVATE"))}Xr();m(rt,ge);m(rt,ge,"esm2017");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const co="firebase-messaging-database",uo=1,T="firebase-messaging-store";let Q=null;function ye(){return Q||(Q=fe(co,uo,{upgrade:(e,t)=>{switch(t){case 0:e.createObjectStore(T)}}})),Q}async function St(e){const t=Ee(e),r=await(await ye()).transaction(T).objectStore(T).get(t);if(r)return r;{const o=await so(e.appConfig.senderId);if(o)return await Ie(e,o),o}}async function Ie(e,t){const n=Ee(e),o=(await ye()).transaction(T,"readwrite");return await o.objectStore(T).put(t,n),await o.done,t}async function lo(e){const t=Ee(e),r=(await ye()).transaction(T,"readwrite");await r.objectStore(T).delete(t),await r.done}function Ee({appConfig:e}){return e.appId}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Lo(e=Un()){return $o().then(t=>{if(!t)throw f.create("unsupported-browser")},t=>{throw f.create("indexed-db-unsupported")}),he(x(e),"messaging").getImmediate()}async function Ot(e,t){return e=x(e),kt(e,t)}function Fo(e){return e=x(e),Ro(e)}function xo(e,t){return e=x(e),Po(e,t)}Mo();const jo={apiKey:"AIzaSyAH2JIEEwn9GfYpfzlTpvUW4s0LD_iRwJQ",authDomain:"silbo-patient-transport.firebaseapp.com",projectId:"silbo-patient-transport",storageBucket:"silbo-patient-transport.firebasestorage.app",messagingSenderId:"27523190820",appId:"1:27523190820:web:6dcd16ac7bf6ff72e008b1"},Ho="BFs1O-6MsXDwy0GEZwqDZiKaToqjiAJ23MIuZTYBtj8k0Psr9NqTv4CTwlQJY5oCJYR4RmO7FhsMfeS0k0iMaBs";let te;function Vo(){return te||(te=Ze(jo)),te}Vo();const $=Lo(),Nt="token_div",Bt="permission_div";xo($,e=>{console.log("Message received. ",e),zo(e)});async function _e(){Go(),R("loading..."),Ot($,{vapidKey:Ho,serviceWorkerRegistration:await navigator.serviceWorker.ready}).then(e=>{e?(Ko(e),Jo(e)):(console.log("No registration token available. Request permission to generate one."),Yo(),P(!1))}).catch(e=>{console.log("An error occurred while retrieving token. ",e),R("Error retrieving registration token."),P(!1)})}function R(e){const t=document.querySelector("#token");t.textContent=e}function Ko(e){Uo()?console.log("Token already sent to server so won't send it again unless it changes"):(console.log("Sending token to server...",e),P(!0))}function Uo(){return window.localStorage.getItem("sentToServer")==="1"}function P(e){window.localStorage.setItem("sentToServer",e?"1":"0")}function L(e,t){const n=document.querySelector("#"+e);t?n.style.display="block":n.style.display="none"}function Wo(){console.log("Requesting permission..."),Notification.requestPermission().then(e=>{console.log("Permission: ",e),e==="granted"?(console.log("Notification permission granted."),_e()):console.log("Unable to get permission to notify.")})}function qo(){Ot($).then(e=>{Fo($).then(()=>{console.log("Token deleted.",e),P(!1),_e()}).catch(t=>{console.log("Unable to delete token. ",t)})}).catch(e=>{console.log("Error retrieving registration token. ",e),R("Error retrieving registration token.")})}function zo(e){const t=document.querySelector("#messages"),n=document.createElement("h5"),r=document.createElement("pre");r.style.overflowX="hidden;",n.textContent="Received message:",r.textContent=JSON.stringify(e,null,2),t.appendChild(n),t.appendChild(r)}function Go(){const e=document.querySelector("#messages");for(;e.hasChildNodes();)e.removeChild(e.lastChild)}function Jo(e){L(Nt,!0),L(Bt,!1),R(e)}function Yo(){L(Nt,!1),L(Bt,!0)}document.getElementById("request-permission-button").addEventListener("click",Wo);document.getElementById("delete-token-button").addEventListener("click",qo);_e();
