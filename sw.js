 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Te(t,e=!1){let n;const r=await q(t.appConfig,i=>{if(!Dt(i))throw D.create("not-registered");const a=i.authToken;if(!e&&Hr(a))return i;if(a.requestStatus===1)return n=Fr(t,e),i;{if(!navigator.onLine)throw D.create("app-offline");const o=Wr(i);return n=Kr(t,o),o}});return n?await n:r.authToken}async function Fr(t,e){let n=await qe(t.appConfig);for(;n.authToken.requestStatus===1;)await It(100),n=await qe(t.appConfig);const r=n.authToken;return r.requestStatus===0?Te(t,e):r}function qe(t){return q(t,e=>{if(!Dt(e))throw D.create("not-registered");const n=e.authToken;return qr(n)?Object.assign(Object.assign({},e),{authToken:{requestStatus:0}}):e})}async function Kr(t,e){try{const n=await Ur(t,e),r=Object.assign(Object.assign({},e),{authToken:n});return await j(t.appConfig,r),n}catch(n){if(gt(n)&&(n.customData.serverCode===401||n.customData.serverCode===404))await St(t.appConfig);else{const r=Object.assign(Object.assign({},e),{authToken:{requestStatus:0}});await j(t.appConfig,r)}throw n}}function Dt(t){return t!==void 0&&t.registrationStatus===2}function Hr(t){return t.requestStatus===2&&!Vr(t)}function Vr(t){const e=Date.now();return e<t.creationTime||t.creationTime+t.expiresIn<e+br}function Wr(t){const e={requestStatus:1,requestTime:Date.now()};return Object.assign(Object.assign({},t),{authToken:e})}function qr(t){return t.requestStatus===1&&t.requestTime+dt<Date.now()}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const At="installations",Xr="installations-internal",Qr=t=>{const e=t.getProvider("app").getImmediate(),n=Yr(e),r=Ie(e,"heartbeat");return{app:e,appConfig:n,heartbeatServiceProvider:r,_delete:()=>Promise.resolve()}},Zr=t=>{const e=t.getProvider("app").getImmediate(),n=Ie(e,At).getImmediate();return{getId:()=>zr(n),getToken:s=>Gr(n,s)}};function es(){N(new S(At,Qr,"PUBLIC")),N(new S(Xr,Zr,"PRIVATE"))}es();k(ht,Ce);k(ht,Ce,"esm2017");/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ks=t=>{const e=new Fs(t.getProvider("app").getImmediate(),t.getProvider("installations-internal").getImmediate(),t.getProvider("analytics-internal"));return self.addEventListener("push",n=>{n.waitUntil(Os(n,e))}),self.addEventListener("pushsubscriptionchange",n=>{n.waitUntil(ks(n,e))}),self.addEventListener("notificationclick",n=>{n.waitUntil(Ns(n))}),e};function Hs(){N(new S("messaging-sw",Ks,"PUBLIC"))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
